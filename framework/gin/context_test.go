...
import (
	...
	testdata "github.com/genganpeng/goweb/framework/gin/testdata/protoexample"
)
...
func TestContextHandlerName(t *testing.T) {
	...
	assert.Regexp(t, "^(.*/vendor/)?github.com/genganpeng/goweb/framework/gin/.handlerNameTest$", c.HandlerName())
}
